...
def main(a_TimeDict, params):
  ...
  ax1.semilogy(simA_tsolve[::params.simA_Skip]*params.timeScaling, np.amin(simA_CFL, axis=(1,2))[::params.simA_Skip], \
  ...
  if params.simB_Dir is not None:
    ax1.semilogy(simB_tsolve[::params.simB_Skip]*params.timeScaling, np.amin(simB_CFL, axis=(1,2))[::params.simB_Skip], \
  ...
  if params.simC_Dir is not None:
    ax1.semilogy(simC_tsolve[::params.simC_Skip]*params.timeScaling, np.amin(simC_CFL, axis=(1,2))[::params.simC_Skip], \
  ...
  if params.simD_Dir is not None:
    ax1.semilogy(simD_tsolve[::params.simD_Skip]*params.timeScaling, np.amin(simD_CFL, axis=(1,2))[::params.simD_Skip], \
  ...
  if params.simE_Dir is not None:
    ax1.semilogy(simE_tsolve[::params.simE_Skip]*params.timeScaling, np.amin(simE_CFL, axis=(1,2))[::params.simE_Skip], \
  ...
  ax1.set_ylabel(r'$\Delta t_{CFL}$', fontsize=16)
